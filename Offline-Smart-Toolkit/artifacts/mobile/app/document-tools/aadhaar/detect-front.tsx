...
export default function DetectFrontScreen() {
  ...
  return (
    <ToolScreenLayout
      title="Auto Detect Front"
      subtitle="Detect and align Aadhaar front side"
    ...
    >
      ...
      <View style={[styles.infoBox, { backgroundColor: COLOR + '12', borderColor: COLOR + '30', borderRadius: colors.radius }]}>
        ...
        <Text style={[styles.infoText, { color: colors.foreground, fontFamily: 'Inter_400Regular' }]}>
          The tool analyses aspect ratio and orientation to detect if the image matches standard Aadhaar front dimensions (85.6×53.98mm, ~1.59 ratio).
        </Text>
      </View>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <Text style={[styles.btnText, { color: '#fff', fontFamily: 'Inter_600SemiBold' }]}>
              {processing ? 'Processing…' : 'Detect & Align Front'}
            </Text>
          </TouchableOpacity>
        </View>
      )}
      ...
      {result && (
        <View style={styles.section}>
          ...
          <DocResultActions
            uri={result.uri}
            fileName="aadhaar-front-aligned.jpg"
            color={COLOR}
            onReset={reset}
            mimeType="image/jpeg"
          />
